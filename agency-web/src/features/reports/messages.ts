...
const rows = [
  ...
  ["Serving agency", "服务代理商", "服務代理商", "Agence de service", "担当代理店", "Обслуживающее агентство", "Đại lý phục vụ"],
  ["Commission source", "佣金来源", "佣金來源", "Source de commission", "コミッション元", "Источник комиссии", "Nguồn hoa hồng"],
  ["Direct customer commission", "直属客户佣金", "直屬客戶佣金", "Commission client direct", "直属顧客コミッション", "Комиссия от прямого клиента", "Hoa hồng khách hàng trực tiếp"],
  ["Child agency spread commission", "下级代理商差价佣金", "下級代理商差價佣金", "Commission sur l’écart de l’agence enfant", "子代理店差額コミッション", "Комиссия с разницы дочернего агентства", "Hoa hồng chênh lệch đại lý con"],
