...
const (
	...
	VerificationScopeWorkbenchAdminStepUp = "workbench.admin.step_up"
)
...
func securityVerificationPolicy(scope string, state model.UserVerificationState) ([]VerificationMethodOption, error) {
	...
	switch scope {
	case VerificationScopeChannelKeyRead, VerificationScopePasskeyDelete, VerificationScopeLogin, VerificationScopeWorkbenchAdminStepUp:
