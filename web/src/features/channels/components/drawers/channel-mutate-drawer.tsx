        ...
        {currentType === 54 && (
          <div className='grid gap-4 border-t pt-4 sm:col-span-2 md:grid-cols-2'>
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('DoubaoVideo submit endpoint')}</FormLabel>
                  <FormControl>
                    <Input
                  ...
                  <FormDescription>
                    {t('Relative upstream path used to create video tasks')}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('DoubaoVideo task query endpoint')}</FormLabel>
                  <FormControl>
                    <Input
