...
func (a *taskPollingFetchAdaptor) FetchTaskAt(baseURL string, _ string, fetchPath string, task *model.Task, _ string) (*http.Response, error) {
	a.mu.Lock()
...
func (a *taskPollingFetchAdaptor) fetch(task *model.Task) (*http.Response, error) {
	taskID := ""
	if task != nil {
