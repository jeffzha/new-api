...
const (
	BillingSourceWallet       = model.TaskBillingSourceWallet
	BillingSourceSubscription = model.TaskBillingSourceSubscription
)
...
func PreConsumeBilling(c *gin.Context, preConsumedQuota int, relayInfo *relaycommon.RelayInfo) *types.NewAPIError {
	...
	upstreamevent.EmitBillingDelta(c, relayInfo, "preconsume", preConsumedQuota, preConsumedQuota, preConsumedQuota, nil)
	return nil
}
